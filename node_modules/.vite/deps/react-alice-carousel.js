...
var require_common2 = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/common.js"(exports) {
    ...
    var __createBinding = Object.create ? function(t, e, i, n) {
      n === void 0 && (n = i), Object.defineProperty(t, n, { enumerable: true, get: function() {
        return e[i];
      } });
    } : function(t, e, i, n) {
      t[n = n === void 0 ? i : n] = e[i];
    };
    ...
    var __importStar = function(t) {
      ...
      if (t != null)
        for (var i in t)
          i !== "default" && Object.hasOwnProperty.call(t, i) && __createBinding(e, t, i);
      return __setModuleDefault(e, t), e;
    };
    var Utils = (Object.defineProperty(exports, "__esModule", { value: true }), exports.calculateInitialState = exports.getItemsInSlide = exports.getIsStageContentPartial = exports.concatClassnames = exports.canUseDOM = void 0, __importStar(require_utils2()));
    exports.canUseDOM = function() {
      var t;
      try {
        return Boolean((t = window === null || window === void 0 ? void 0 : window.document) == null ? void 0 : t.createElement);
      } catch (t2) {
        return false;
      }
      ...
      return e === void 0 && (e = 0), i === void 0 && (i = 0), !(t = t !== void 0 && t) && i <= e;
    }, exports.getItemsInSlide = function(e, t) {
      var i, n = 1, o = t.responsive, a = t.autoWidth, r = t.infinite, t = t.innerWidth;
      return a !== void 0 && a ? r !== void 0 && r ? e : n : (o && (a = Object.keys(o)).length && (t || exports.canUseDOM()) && (i = t || window.innerWidth, a.forEach(function(t2) {
        Number(t2) < i && (n = Math.min(o[t2].items, e) || n);
      })), n);
    }, exports.calculateInitialState = function(t, e, i) {
      i === void 0 && (i = false);
      var n, o, a = t.animationDuration, a = a === void 0 ? 0 : a, r = t.infinite, r = r !== void 0 && r, s = t.autoPlay, s = s !== void 0 && s, l = t.autoWidth, l = l !== void 0 && l, d = Utils.createClones(t), u = Utils.getTransitionProperty(), c = Utils.getItemsCount(t), f = Utils.getItemsOffset(t), m = exports.getItemsInSlide(c, t), p = Utils.getStartIndex(t.activeIndex, c), p = Utils.getActiveIndex({ startIndex: p, itemsCount: c, infinite: r }), g = Utils.getElementDimensions(e).width, v = (n = (o = (e = l ? (n = (e = Utils.createAutowidthTransformationSet(e, g, r)).coords, o = e.content, e.partial) : (n = (e = Utils.createDefaultTransformationSet(d, g, m, r)).coords, o = e.content, e.partial), o), n), Utils.getItemCoords(-m, n).position), S = Utils.getSwipeLimitMin({ itemsOffset: f, transformationSet: n }, t), t = Utils.getSwipeLimitMax({ itemsCount: c, itemsOffset: f, itemsInSlide: m, transformationSet: n }, t), x = Utils.getSwipeShiftValue(c, n);
      return { activeIndex: p, autoWidth: l, animationDuration: a, clones: d, infinite: r, itemsCount: c, itemsInSlide: m, itemsOffset: f, translate3d: Utils.getTranslate3dProperty(p, { itemsInSlide: m, itemsOffset: f, transformationSet: n, autoWidth: l, infinite: r }), stageWidth: g, stageContentWidth: o, initialStageHeight: 0, isStageContentPartial: e, isAutoPlaying: Boolean(s), isAutoPlayCanceledOnAction: false, transformationSet: n, transition: u, fadeoutAnimationIndex: null, fadeoutAnimationPosition: null, fadeoutAnimationProcessing: false, swipeLimitMin: S, swipeLimitMax: t, swipeAllowedPositionMax: v, swipeShiftValue: x, canUseDom: i || exports.canUseDOM() };
    };
  }
});
...
var require_elements = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/elements.js"(exports) {
    ...
    function shouldHandleResizeEvent(t, e, r) {
      return (e = e === void 0 ? {} : e).width !== (r = r === void 0 ? {} : r).width;
    }
    function animate(t, e) {
      var e = e || {}, r = e.position, r = r === void 0 ? 0 : r, n = e.animationDuration, n = n === void 0 ? 0 : n, e = e.animationEasingFunction, e = e === void 0 ? "ease" : e;
    ...
    exports.getSlides = function(t) {
      ...
      return e ? e.length ? e : [e] : t === void 0 ? [] : t;
      ...
      if (!t.infinite)
        return e;
      var r = exports.getItemsCount(t), n = exports.getItemsOffset(t), t = Utils.getItemsInSlide(r, t), i = Math.min(t, r) + n, o = e.slice(0, i), i = e.slice(-i);
      return n && t === r && (n = e[0], t = e.slice(-1)[0], i.unshift(t), o.push(n)), i.concat(e, o);
      ...
      o === void 0 && (o = 0), e === void 0 && (e = false);
      var s = 0, a = true, r = [];
      return exports.isElement(t) && (r = Array.from(t.children || []).reduce(function(t2, e2, r2) {
        var n = 0, r2 = r2 - 1, i = t2[r2], e2 = getElementDimensions(e2 == null ? void 0 : e2.firstChild).width, e2 = e2 === void 0 ? 0 : e2;
        return a = (s += e2) <= o, i && (n = r2 == 0 ? i.width : i.width + i.position), t2.push({ position: n, width: e2 }), t2;
      }, []), e || (r = a ? Utils.mapPartialCoords(r) : (t = s - o, Utils.mapPositionCoords(r, t)))), { coords: r, content: s, partial: a };
    }, exports.createDefaultTransformationSet = function(t, i, e, r) {
      r === void 0 && (r = false);
      var o = 0, s = true, n = [], a = exports.getItemWidth(i, e);
      return n = t.reduce(function(t2, e2, r2) {
        var n2 = 0, r2 = t2[r2 - 1];
        return s = (o += a) <= i, r2 && (n2 = a + r2.position || 0), t2.push({ width: a, position: n2 }), t2;
      }, []), { coords: n = r ? n : s ? Utils.mapPartialCoords(n) : (e = o - i, Utils.mapPositionCoords(n, e)), content: o, partial: s };
      ...
      var n = t || {}, i = n.paddingLeft, o = n.paddingRight, s = n.autoHeight, n = n.animationDuration, s = s ? exports.getAutoheightProperty(r, t, e) : void 0;
      return { height: s, transition: s ? "height " + n + "ms" : void 0, paddingLeft: i + "px", paddingRight: o + "px" };
    }, exports.getTransitionProperty = function(t) {
      var t = t || {}, e = t.animationDuration, t = t.animationEasingFunction;
      return "transform " + (e === void 0 ? 0 : e) + "ms " + (t === void 0 ? "ease" : t) + " 0ms";
    }, exports.getRenderStageStyles = function(t, e) {
      t = (t || {}).translate3d, t = "translate3d(" + -(t === void 0 ? 0 : t) + "px, 0, 0)";
      return __assign(__assign({}, e), { transform: t });
    }, exports.getRenderStageItemStyles = function(t, e) {
      var r = e.transformationSet, n = e.fadeoutAnimationIndex, i = e.fadeoutAnimationPosition, o = e.fadeoutAnimationProcessing, e = e.animationDuration, r = (r[t] || {}).width;
      return o && n === t ? { transform: "translateX(" + i + "px)", animationDuration: e + "ms", width: r + "px" } : { width: r };
    }, exports.getTranslate3dProperty = function(t, e) {
      var r = t, n = e.infinite, i = e.itemsOffset, o = e.itemsInSlide, e = e.transformationSet;
      return ((e === void 0 ? [] : e)[r = n ? t + Utils.getShiftIndex(o === void 0 ? 0 : o, i === void 0 ? 0 : i) : r] || {}).position || 0;
...
var require_classnames = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/classnames.js"(exports) {
    ...
    var __createBinding = Object.create ? function(e, t, i, r) {
      r === void 0 && (r = i), Object.defineProperty(e, r, { enumerable: true, get: function() {
        return t[i];
      } });
    } : function(e, t, i, r) {
      e[r = r === void 0 ? i : r] = t[i];
    };
    ...
    var __importStar = function(e) {
      if (e && e.__esModule)
        return e;
      var t = {};
      if (e != null)
        for (var i in e)
          i !== "default" && Object.hasOwnProperty.call(e, i) && __createBinding(t, e, i);
      return __setModuleDefault(t, e), t;
    };
    var Utils = (Object.defineProperty(exports, "__esModule", { value: true }), exports.isClonedItem = exports.isTargetItem = exports.isActiveItem = exports.getRenderStageItemClasses = void 0, __importStar(require_utils2()));
    var types_1 = require_types2();
    exports.getRenderStageItemClasses = function(e, t) {
      e === void 0 && (e = 0);
      var i = t.fadeoutAnimationIndex, r = exports.isActiveItem(e, t) ? types_1.Modifiers.ACTIVE : "", n = exports.isClonedItem(e, t) ? types_1.Modifiers.CLONED : "", t = exports.isTargetItem(e, t) ? types_1.Modifiers.TARGET : "", e = e === i ? types_1.Classnames.ANIMATED : "";
      return Utils.concatClassnames(types_1.Classnames.STAGE_ITEM, r, n, t, e);
    }, exports.isActiveItem = function(e, t) {
      e === void 0 && (e = 0);
      var i = t.activeIndex, r = t.itemsInSlide, n = t.itemsOffset, s = t.infinite, t = t.autoWidth, o = Utils.getShiftIndex(r, n);
      if (t && s)
        return e - o === i + n;
      t = i + o;
      ...
      e === void 0 && (e = 0);
      var i = t.activeIndex, r = t.itemsInSlide, n = t.itemsOffset, s = t.infinite, t = t.autoWidth, r = Utils.getShiftIndex(r, n);
      return s ? t && s ? e - r === i + n : e === i + r : e === i;
    }, exports.isClonedItem = function(e, t) {
      e === void 0 && (e = 0);
      var i = t.itemsInSlide, r = t.itemsOffset, n = t.itemsCount, s = t.infinite, t = t.autoWidth;
      if (!s)
        return false;
      if (t && s)
        return e < i || n - 1 + i < e;
      t = Utils.getShiftIndex(i, r);
      return e < t || n - 1 + t < e;
    };
  }
});
...
var require_math = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/math.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true }), exports.isVerticalTouchmoveDetected = exports.getFadeoutAnimationPosition = exports.getFadeoutAnimationIndex = exports.getSwipeTouchendIndex = exports.getSwipeTouchendPosition = exports.getSwipeTransformationCursor = exports.getTransformationItemIndex = exports.getSwipeShiftValue = exports.getItemCoords = exports.getIsLeftDirection = exports.shouldRecalculateSwipePosition = exports.getSwipeLimitMax = exports.getSwipeLimitMin = exports.shouldCancelSlideAnimation = exports.shouldRecalculateSlideIndex = exports.getUpdateSlidePositionIndex = exports.getActiveIndex = exports.getStartIndex = exports.getShiftIndex = void 0, exports.getShiftIndex = function(t, e) {
      return (t = t === void 0 ? 0 : t) + (e = e === void 0 ? 0 : e);
    }, exports.getStartIndex = function(t, e) {
      if (t === void 0 && (t = 0), e = e === void 0 ? 0 : e) {
        if (e <= t)
          return e - 1;
        if (0 < t)
          return t;
      ...
      var e = t.startIndex, e = e === void 0 ? 0 : e, i = t.itemsCount, t = t.infinite;
      return t !== void 0 && t ? e : exports.getStartIndex(e, i === void 0 ? 0 : i);
      ...
      var i = t.itemsOffset, t = t.transformationSet, t = t === void 0 ? [] : t, o = e.infinite, e = e.swipeExtraPadding;
      if (o)
        return (t[i === void 0 ? 0 : i] || {}).position;
      o = (t[0] || {}).width;
      return Math.min(e === void 0 ? 0 : e, o === void 0 ? 0 : o);
    }, exports.getSwipeLimitMax = function(t, e) {
      var i = e.infinite, e = e.swipeExtraPadding, e = e === void 0 ? 0 : e, o = t.itemsCount, n = t.itemsOffset, r = t.itemsInSlide, r = r === void 0 ? 1 : r, t = t.transformationSet, t = t === void 0 ? [] : t;
      return i ? (t[(o === void 0 ? 1 : o) + exports.getShiftIndex(r, n === void 0 ? 0 : n)] || {}).position || 0 : exports.getItemCoords(-r, t).position + e;
    }, exports.shouldRecalculateSwipePosition = function(t, e, i) {
      return -e <= t || Math.abs(t) >= i;
    }, exports.getIsLeftDirection = function(t) {
      return (t = t === void 0 ? 0 : t) < 0;
    }, exports.getItemCoords = function(t, e) {
      return (e = e === void 0 ? [] : e).slice(t = t === void 0 ? 0 : t)[0] || { position: 0, width: 0 };
    }, exports.getSwipeShiftValue = function(t, e) {
      return t === void 0 && (t = 0), e === void 0 && (e = []), exports.getItemCoords(t, e).position;
    }, exports.getTransformationItemIndex = function(t, e) {
      return e === void 0 && (e = 0), (t = t === void 0 ? [] : t).findIndex(function(t2) {
        return t2.position >= Math.abs(e);
      });
    }, exports.getSwipeTransformationCursor = function(t, e, i) {
      t === void 0 && (t = []), e === void 0 && (e = 0), i === void 0 && (i = 0);
      ...
      return t < (i = i === void 0 ? 0 : i) || t < 0.1 * e;
    };
  }
});
...
var require_render = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/render.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true }), exports.getSlideItemInfo = exports.getSlideInfo = exports.getSlideIndexForMultipleItems = exports.getSlideIndexForNonMultipleItems = exports.getActiveSlideDotsLength = exports.getActiveSlideIndex = void 0, exports.getActiveSlideIndex = function(e, t) {
      ...
      return o === 1 ? exports.getSlideIndexForNonMultipleItems(i, o, t) : exports.getSlideIndexForMultipleItems(i, o, t, e);
    }, exports.getActiveSlideDotsLength = function(e, t) {
      var i;
      return t === void 0 && (t = 1), (e = e === void 0 ? 0 : e) && t ? (i = Math.floor(e / t), e % t == 0 ? i - 1 : i) : 0;
      ...
      return e === i + t ? 0 : o || e < t && e !== 0 ? n : e === 0 ? i % t == 0 ? n : n - 1 : 0 < t ? Math.floor(e / t) - 1 : 0;
      ...
      return e.isStageContentPartial ? { isPrevSlideDisabled: true, isNextSlideDisabled: true } : { isPrevSlideDisabled: o === false && i === 0, isNextSlideDisabled: o === false && n - t <= i };
    };
  }
});
...
var require_controls = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/controls.js"(exports) {
    ...
    var __createBinding = Object.create ? function(t, e, o, s) {
      s === void 0 && (s = o), Object.defineProperty(t, s, { enumerable: true, get: function() {
        return e[o];
      } });
    } : function(t, e, o, s) {
      t[s = s === void 0 ? o : s] = e[o];
    };
    var __setModuleDefault = Object.create ? function(t, e) {
      Object.defineProperty(t, "default", { enumerable: true, value: e });
    } : function(t, e) {
    ...
    var __importStar = function(t) {
      ...
      if (t != null)
        for (var o in t)
          o !== "default" && Object.hasOwnProperty.call(t, o) && __createBinding(e, t, o);
      return __setModuleDefault(e, t), e;
    };
    var types_1 = (Object.defineProperty(exports, "__esModule", { value: true }), exports.shouldCancelAutoPlayOnHover = exports.shouldCancelAutoPlayOnAction = exports.getItemIndexForDotNavigation = exports.checkIsTheLastDotIndex = exports.getDotsNavigationLength = exports.hasDotForEachSlide = exports.isStrategy = exports.shouldDisableButtons = exports.shouldDisableDots = exports.shouldDisableControls = void 0, require_types2());
    var Utils = __importStar(require_utils2());
    function shouldDisableControls(t, e) {
      var t = (t || {}).controlsStrategy, e = e || {}, o = e.itemsInSlide, s = e.itemsCount, e = e.autoWidth;
      if (Utils.isStrategy(t, types_1.ControlsStrategy.RESPONSIVE))
        return !e && o === s;
    }
    ...
    exports.shouldDisableControls = shouldDisableControls, exports.shouldDisableDots = shouldDisableDots, exports.shouldDisableButtons = shouldDisableButtons, exports.isStrategy = function(t, e) {
      ...
      return t === void 0 && (t = 0), e === void 0 && (e = 1), o ? t : Number(e) !== 0 && Math.ceil(t / e) || 0;
      ...
      return (t = t === void 0 ? "" : t) === types_1.AutoPlayStrategy.ACTION || t === types_1.AutoPlayStrategy.ALL;
    }, exports.shouldCancelAutoPlayOnHover = function(t) {
      return (t = t === void 0 ? "" : t) === types_1.AutoPlayStrategy.DEFAULT || t === types_1.AutoPlayStrategy.ALL;
    };
  }
});
...
var require_mappers = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/mappers.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true }), exports.mapPositionCoords = exports.mapPartialCoords = void 0, exports.mapPartialCoords = function(o) {
      ...
      return t === void 0 && (t = 0), o.map(function(o2) {
...
var require_utils2 = __commonJS({
  "node_modules/react-alice-carousel/lib/utils/index.js"(exports) {
    ...
    var __createBinding = Object.create ? function(e, r, t, o) {
      o === void 0 && (o = t), Object.defineProperty(e, o, { enumerable: true, get: function() {
        return r[t];
      } });
    } : function(e, r, t, o) {
      e[o = o === void 0 ? t : o] = r[t];
    };
    var __exportStar = function(e, r) {
      for (var t in e)
        t === "default" || r.hasOwnProperty(t) || __createBinding(r, e, t);
    };
...
var require_SlideInfo = __commonJS({
  "node_modules/react-alice-carousel/lib/views/SlideInfo.js"(exports) {
    ...
    var __createBinding = Object.create ? function(e, t, a, r) {
      r === void 0 && (r = a), Object.defineProperty(e, r, { enumerable: true, get: function() {
        return t[a];
      } });
    } : function(e, t, a, r) {
      e[r = r === void 0 ? a : r] = t[a];
    };
    var __setModuleDefault = Object.create ? function(e, t) {
      Object.defineProperty(e, "default", { enumerable: true, value: t });
    } : function(e, t) {
    ...
    exports.SlideInfo = function(e) {
      var t = e.activeIndex, a = e.itemsCount, e = e.renderSlideInfo, t = Utils.getSlideInfo(t, a).item;
      if (typeof e == "function")
        return react_1.default.createElement("div", { className: types_1.Classnames.SLIDE_INFO }, e({ item: t, itemsCount: a }));
      e = Utils.concatClassnames(types_1.Classnames.SLIDE_INFO_ITEM, types_1.Modifiers.SEPARATOR);
      return react_1.default.createElement("div", { className: types_1.Classnames.SLIDE_INFO }, react_1.default.createElement("span", { className: types_1.Classnames.SLIDE_INFO_ITEM }, t), react_1.default.createElement("span", { className: e }, "/"), react_1.default.createElement("span", { className: types_1.Classnames.SLIDE_INFO_ITEM }, a));
    };
  }
});
...
var require_DotsNavigation = __commonJS({
  "node_modules/react-alice-carousel/lib/views/DotsNavigation.js"(exports) {
    ...
    var __createBinding = Object.create ? function(e, t, i, n) {
      n === void 0 && (n = i), Object.defineProperty(e, n, { enumerable: true, get: function() {
        return t[i];
      } });
    } : function(e, t, i, n) {
      e[n = n === void 0 ? i : n] = t[i];
    };
    var __setModuleDefault = Object.create ? function(e, t) {
      Object.defineProperty(e, "default", { enumerable: true, value: t });
    } : function(e, t) {
    ...
    exports.DotsNavigation = function(e) {
      var a = e.state, o = e.onClick, s = e.onMouseEnter, l = e.onMouseLeave, t = e.controlsStrategy, u = e.renderDotsItem, c = a.itemsCount, d = a.itemsInSlide, f = a.infinite, e = a.autoWidth, _ = a.activeIndex, m = Utils.getSlideItemInfo(a).isNextSlideDisabled, v = Utils.hasDotForEachSlide(e, t), p = Utils.getDotsNavigationLength(c, d, v);
      return react_1.default.createElement("ul", { className: types_1.Classnames.DOTS }, Array.from({ length: c }).map(function(e2, t2) {
        var i, n, r;
        if (t2 < p)
          return n = Utils.checkIsTheLastDotIndex(t2, Boolean(f), p), i = Utils.getItemIndexForDotNavigation(t2, n, c, d), n = Utils.getActiveSlideIndex(m, a), v && ((n = _) < 0 ? n = c - 1 : c <= _ && (n = 0), i = t2), n = n === t2 ? types_1.Modifiers.ACTIVE : "", r = u ? types_1.Modifiers.CUSTOM : "", r = Utils.concatClassnames(types_1.Classnames.DOTS_ITEM, n, r), react_1.default.createElement("li", { key: "dot-item-" + t2, onMouseEnter: s, onMouseLeave: l, onClick: function() {
            return o(i);
          }, className: r }, u && u({ isActive: n, activeIndex: t2 }));
      }));
    };
  }
});
...
var require_PlayPauseButton = __commonJS({
  "node_modules/react-alice-carousel/lib/views/PlayPauseButton.js"(exports) {
    ...
    exports.PlayPauseButton = function(e) {
      ...
      e = t ? types_1.Modifiers.PAUSE : "", t = Utils.concatClassnames(types_1.Classnames.PLAY_BTN_ITEM, e);
...
var require_PrevNextButton = __commonJS({
  "node_modules/react-alice-carousel/lib/views/PrevNextButton.js"(exports) {
    ...
    exports.PrevNextButton = function(e) {
      var t = e.name, a = e.isDisabled, r = e.onClick, s = e.renderPrevButton, e = e.renderNextButton;
      if (typeof s == "function")
        return react_1.default.createElement("div", { className: types_1.Classnames.BUTTON_PREV, onClick: r }, s({ isDisabled: a }));
      if (typeof e == "function")
        return react_1.default.createElement("div", { className: types_1.Classnames.BUTTON_NEXT, onClick: r }, e({ isDisabled: a }));
      var s = t === "prev", e = s ? "<" : ">", t = s ? types_1.Classnames.BUTTON_PREV : types_1.Classnames.BUTTON_NEXT, n = s ? types_1.Classnames.BUTTON_PREV_WRAPPER : types_1.Classnames.BUTTON_NEXT_WRAPPER, s = s ? types_1.Classnames.BUTTON_PREV_ITEM : types_1.Classnames.BUTTON_NEXT_ITEM, a = a ? types_1.Modifiers.INACTIVE : "", s = Utils.concatClassnames(s, a);
      return react_1.default.createElement("div", { className: t }, react_1.default.createElement("div", { className: n }, react_1.default.createElement("p", { className: s, onClick: r }, react_1.default.createElement("span", { "data-area": e }))));
    };
  }
});
  ...
  "node_modules/react-alice-carousel/lib/react-alice-carousel.js"(exports) {
    ...
    var __extends = function() {
      ...
      return function(t, e) {
        ...
        n(t, e), t.prototype = e === null ? Object.create(e) : (i.prototype = e.prototype, new i());
      };
    }();
    var __assign = function() {
      return (__assign = Object.assign || function(t) {
    ...
    var __exportStar = function(t, e) {
      for (var i in t)
        i === "default" || e.hasOwnProperty(i) || __createBinding(e, t, i);
    };
            ...
            try {
              ...
              switch (a = 0, (e2 = r ? [2 & e2[0], r.value] : e2)[0]) {
                ...
                case 7:
                  ...
                  continue;
                default:
                  if (!(r = 0 < (r = l.trys).length && r[r.length - 1]) && (e2[0] === 6 || e2[0] === 2)) {
                    l = 0;
                    continue;
                  }
                  if (e2[0] === 3 && (!r || e2[1] > r[0] && e2[1] < r[3])) {
                    l.label = e2[1];
                    break;
                  }
                  if (e2[0] === 6 && l.label < r[1]) {
                    l.label = r[1], r = e2;
                    break;
                  }
                  if (r && l.label < r[2]) {
    ...
    var AliceCarousel = (__exportStar(require_types2(), exports), function(e) {
      ...
      return __extends(t, e), t.prototype.componentDidMount = function() {
        ...
        if (this.hasUserAction = true, !(s || !this.isTouchMoveProcessStarted && Utils.isVerticalTouchmoveDetected(n, i, e2))) {
          ...
          if (u === false)
            return r < d || d < -l ? void 0 : void Utils.animate(this.stageComponent, { position: d });
        ...
        this.touchEndTimeoutId = window.setTimeout(function() {
          return __awaiter(t2, void 0, void 0, function() {
            ...
            return __generator(this, function(t3) {
              switch (t3.label) {
                case 0:
                  return e3 = Utils.getSwipeTouchendIndex(o, this.state), i = Utils.getTranslate3dProperty(e3, this.state), Utils.animate(this.stageComponent, { position: -i }), n = Utils.getTransitionProperty(), [4, this.setState({ activeIndex: e3, translate3d: i, transition: n })];
                case 1:
                  return t3.sent(), [4, this._handleSlideChanged()];
                case 2:
                  return t3.sent(), [2];
              }
            });
        ...
        var e2 = t2.activeIndex, a = e2 === void 0 ? 0 : e2, e2 = t2.fadeoutAnimationIndex, r = e2 === void 0 ? null : e2, e2 = t2.fadeoutAnimationPosition, l = e2 === void 0 ? null : e2, u = t2.eventType;
        return __awaiter(this, void 0, void 0, function() {
          var e3, i, n, o, s = this;
          return __generator(this, function(t3) {
            switch (t3.label) {
              case 0:
                return (i = this.props, n = i.infinite, i = i.animationEasingFunction, e3 = this.state, o = e3.itemsCount, e3 = e3.animationDuration, this.isAnimationDisabled || this.state.activeIndex === a || !n && Utils.shouldCancelSlideAnimation(a, o)) ? [2] : (this.isAnimationDisabled = true, this._cancelTimeoutAnimations(), this._handleSlideChange(u), n = false, o = Utils.getTranslate3dProperty(a, this.state), i = r !== null && l !== null ? (n = true, Utils.getTransitionProperty()) : Utils.getTransitionProperty({ animationDuration: e3, animationEasingFunction: i }), [4, this.setState({ activeIndex: a, transition: i, translate3d: o, animationDuration: e3, fadeoutAnimationIndex: r, fadeoutAnimationPosition: l, fadeoutAnimationProcessing: n })]);
              case 1:
        ...
        var e2 = this;
        t2 === void 0 && (t2 = this.props), this._cancelTimeoutAnimations(), this.isAnimationDisabled = false, this.state.isAutoPlaying && this._handlePlay(), this.setState({ clones: Utils.createClones(t2) }), requestAnimationFrame(function() {
